...
@Index("PK_FPMA_Master_Department", ["itemId"], { unique: true })
@Entity("FPMA_Master_Department", { schema: "dbo" })
export class FpmaMasterDepartment {
  ...
  @Column("int", { name: "division_id", default: () => "(0)" })
  divisionId: number;
