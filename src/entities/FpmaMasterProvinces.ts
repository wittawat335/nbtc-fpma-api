...
@Index("PK_FPMA_Master_Provinces", ["itemId"], { unique: true })
@Entity("FPMA_Master_Provinces", { schema: "dbo" })
export class FpmaMasterProvinces {
  ...
  @Column("int", { name: "geography_id", nullable: true })
