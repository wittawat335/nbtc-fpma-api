...
@Index("PK_FPMA_Master_Preparedness_sub", ["itemId"], { unique: true })
@Entity("FPMA_Master_Preparedness_sub", { schema: "dbo" })
export class FpmaMasterPreparednessSub {
  ...
  @Column("int", { name: "preparedness_id", default: () => "(0)" })
  preparednessId: number;
