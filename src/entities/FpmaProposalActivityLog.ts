...
@Index("PK_FPMA_Proposal_Activity_Log", ["itemId"], { unique: true })
@Entity("FPMA_Proposal_Activity_Log", { schema: "dbo" })
export class FpmaProposalActivityLog {
  ...
  @Column("int", { name: "proposal_step_id", nullable: true })
  proposalStepId: number | null;
}
