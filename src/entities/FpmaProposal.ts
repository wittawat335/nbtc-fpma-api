import { jsonTransformer } from 'src/common/transformers/json.transformer';
import {
  ContactAddressDto,
  ContactPersonDto,
  LocationAddressDto,
  MandatePersonDto,
  PersonDto,
} from 'src/modules/proposal/dto/create-proposal-shared.dto';
...
@Index('PK_FPMA_Proposal', ['itemId'], { unique: true })
@Entity('FPMA_Proposal', { schema: 'dbo' })
export class FpmaProposal {
  ...
  @Column('nvarchar', {
    name: 'resposiible_person',
    nullable: true,
    transformer: jsonTransformer,
  })
  resposiiblePerson: PersonDto | null;
  ...
  authorityPerson: PersonDto | null;

  @Column('nvarchar', {
    name: 'attorney_person',
    nullable: true,
    transformer: jsonTransformer,
  })
  attorneyPerson: MandatePersonDto | null;
  ...
  projectAddress: LocationAddressDto | null;
  ...
  @OneToMany(() => FpmaProposalFile, (proposalFile) => proposalFile.proposal)
