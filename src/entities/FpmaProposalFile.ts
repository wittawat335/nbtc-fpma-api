...
import { FpmaProposal } from './FpmaProposal';
import { FpmaFile } from './FpmaFile';
...
export class FpmaProposalFile {
  ...
  // เชื่อมกับ Proposal
  @ManyToOne(() => FpmaProposal, (proposal) => proposal.proposalFiles)
  @JoinColumn({ name: 'proposal_id' })
  proposal: FpmaProposal;

  // เชื่อมกับ File
  @ManyToOne(() => FpmaFile, (file) => file.proposalFiles)
